...
if (isset($_POST['save'])) {
    ...
    $insert_query = "INSERT INTO `order` (client_id, modeofreceiving_id, order_status, payment_status, total_price, order_date, fulfillment_date) VALUES ('$client_id', '$modeofreceiving_id', '$order_status', '$payment_status', '$total_price', '$order_date', '$fulfillment_date')";
...
if (isset($_POST['update']))
{
    ...
    $order_date = $_POST['order_date'];
    $fulfillment_date = $_POST['fulfillment_date'];
    $update_query = "UPDATE `order` SET client_id = '$client_id', modeofreceiving_id = '$modeofreceiving_id', order_status = '$order_status', payment_status ='$payment_status' , total_price='$total_price' , order_date='$order_date' , fulfillment_date='$fulfillment_date' WHERE order_id = '$id'";
