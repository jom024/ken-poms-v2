...
<div id="page-content-wrapper">
                            ...
                            <?php foreach ($notifications as $notification): ?>
                                <li>
                                    <a class="dropdown-item" href="#">
                                        Mode of Receiving #<?= htmlspecialchars($notification['modeofreceiving_id']) ?> added: <?= htmlspecialchars($notification['type']) ?>
                                    </a>
                                </li>
                            <?php endforeach; ?>
                        <?php else: ?>
    ...
    $query = "SELECT * FROM `mode_of_receiving` WHERE `modeofreceiving_id` > 1 ORDER BY `modeofreceiving_id` ASC";
