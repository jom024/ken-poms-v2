                            ...
                            <?php foreach ($notifications as $notification): ?>
                                <li>
                                    <a class="dropdown-item" href="#">
                                        Order #<?= htmlspecialchars($notification['order_id']) ?>: <?= htmlspecialchars($notification['order_status']) ?>
                                    </a>
                                </li>
                            <?php endforeach; ?>
                        <?php else: ?>
...
function get_new_notifications($connection) {
    ...
    $query = "SELECT * FROM `order` WHERE DATE(`order_date`) = CURDATE() ORDER BY `order_date` DESC";
